...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.6\textwidth]{figs/fig.png}
...
\begin{equation}
  \textit{GCN}(\boldsymbol{B},\boldsymbol{A}) = \tilde{\boldsymbol{A}} \textit{tanh}\left( \tilde{\boldsymbol{A}} \boldsymbol{B}\boldsymbol{W}_0 \right) \boldsymbol{W}_1
\end{equation}
